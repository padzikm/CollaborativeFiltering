...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	public partial class Model6_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>Field backing the vVector__7 property</summary>
		private Vector[] VVector__7;
		/// <summary>The number of iterations last computed by Changed_vVector__7. Set this to zero to force re-execution of Changed_vVector__7</summary>
		public int Changed_vVector__7_iterationsDone;
		public PointMass<Vector[]> vVector__7_marginal;
		/// <summary>Message to marginal of 'vVector21'</summary>
		public VectorGaussian vVector21_marginal_F;
		...
		/// <summary>The externally-specified value of 'vVector__7'</summary>
		public Vector[] vVector__7
		{
			get {
				return this.VVector__7;
			}
			set {
				if ((value!=null)&&(value.Length!=1)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+1)+" was expected for variable \'vVector__7\'");
				}
				this.VVector__7 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vVector__7_iterationsDone = 0;
			}
		}
		...
		{
			if (variableName=="vVector__7") {
				return this.VVector__7Marginal();
			}
			if (variableName=="vVector21") {
				return this.VVector21Marginal();
			}
		...
		private void Changed_vVector__7()
		{
			...
			VectorGaussian vVectorGaussian7 = VectorGaussian.FromNatural(DenseVector.FromArray(new double[3] {1547829870.0, 525077980.0, 200270.0}), new PositiveDefiniteMatrix(new double[3, 3] {{4254590363351.0, 1127383488860.0, 433199230.0}, {1127383488860.0, 482723521821.0, 146764360.0}, {433199230.0, 146764360.0, 56221.0}}));
		...
		/// <summary>
		/// Returns the marginal distribution for 'vVector__7' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public PointMass<Vector[]> VVector__7Marginal()
		{
			return this.vVector__7_marginal;
		}

		/// <summary>
		/// Returns the marginal distribution for 'vVector21' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public VectorGaussian VVector21Marginal()
		{
			return this.vVector21_marginal_F;
		}
