...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	public partial class Model110_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>Field backing the vVector__111 property</summary>
		private Vector[] VVector__111;
		/// <summary>The number of iterations last computed by Changed_vVector__111. Set this to zero to force re-execution of Changed_vVector__111</summary>
		public int Changed_vVector__111_iterationsDone;
		public PointMass<Vector[]> vVector__111_marginal;
		/// <summary>Message to marginal of 'vVector333'</summary>
		public VectorGaussian vVector333_marginal_F;
		/// <summary>Message to marginal of 'vdouble__334'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__334_marginal_F;
		/// <summary>Message to marginal of 'vdouble__333'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__333_marginal_F;
		#endregion
		...
		/// <summary>The externally-specified value of 'vVector__111'</summary>
		public Vector[] vVector__111
		{
			get {
				return this.VVector__111;
			}
			set {
				if ((value!=null)&&(value.Length!=1)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+1)+" was expected for variable \'vVector__111\'");
				}
				this.VVector__111 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vVector__111_iterationsDone = 0;
			}
		}
		...
		{
			if (variableName=="vVector__111") {
				this.vVector__111 = (Vector[])value;
				return ;
			}
			throw new ArgumentException("Not an observed variable name: "+variableName);
		}
		...
		{
			if (variableName=="vVector__111") {
				return this.VVector__111Marginal();
			}
			if (variableName=="vVector333") {
				return this.VVector333Marginal();
			}
			if (variableName=="vdouble__333") {
				return this.Vdouble__333Marginal();
			}
			if (variableName=="vdouble__334") {
				return this.Vdouble__334Marginal();
			}
		...
		private void Changed_vVector__111()
		{
			...
			VectorGaussian vVectorGaussian111 = VectorGaussian.FromNatural(DenseVector.FromArray(new double[3] {1547829870.0, 525077980.0, 200270.0}), new PositiveDefiniteMatrix(new double[3, 3] {{4254590363351.0, 1127383488860.0, 433199230.0}, {1127383488860.0, 482723521821.0, 146764360.0}, {433199230.0, 146764360.0, 56221.0}}));
		...
		/// <summary>
		/// Returns the marginal distribution for 'vVector__111' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public PointMass<Vector[]> VVector__111Marginal()
		{
			return this.vVector__111_marginal;
		}

		/// <summary>
		/// Returns the marginal distribution for 'vVector333' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public VectorGaussian VVector333Marginal()
		{
			return this.vVector333_marginal_F;
		}

		/// <summary>
		/// Returns the marginal distribution for 'vdouble__333' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public DistributionStructArray<Gaussian,double> Vdouble__333Marginal()
		{
			return this.vdouble__333_marginal_F;
		}

		/// <summary>
		/// Returns the marginal distribution for 'vdouble__334' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public DistributionStructArray<Gaussian,double> Vdouble__334Marginal()
		{
			return this.vdouble__334_marginal_F;
		}
