...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	public partial class Model26_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>Field backing the vVector__27 property</summary>
		private Vector[] VVector__27;
		/// <summary>The number of iterations last computed by Changed_vVector__27. Set this to zero to force re-execution of Changed_vVector__27</summary>
		public int Changed_vVector__27_iterationsDone;
		public PointMass<Vector[]> vVector__27_marginal;
		/// <summary>Message to marginal of 'vVector81'</summary>
		public VectorGaussian vVector81_marginal_F;
		/// <summary>Message to marginal of 'vdouble__82'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__82_marginal_F;
		/// <summary>Message to marginal of 'vdouble__81'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__81_marginal_F;
		#endregion
		...
		/// <summary>The externally-specified value of 'vVector__27'</summary>
		public Vector[] vVector__27
		{
			get {
				return this.VVector__27;
			}
			set {
				if ((value!=null)&&(value.Length!=1)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+1)+" was expected for variable \'vVector__27\'");
				}
				this.VVector__27 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vVector__27_iterationsDone = 0;
			}
		}
		...
		{
			if (variableName=="vVector__27") {
				return this.VVector__27Marginal();
			}
			if (variableName=="vVector81") {
				return this.VVector81Marginal();
			}
			if (variableName=="vdouble__81") {
				return this.Vdouble__81Marginal();
			}
			if (variableName=="vdouble__82") {
				return this.Vdouble__82Marginal();
			}
		...
		private void Changed_vVector__27()
		{
			...
			VectorGaussian vVectorGaussian27 = VectorGaussian.FromNatural(DenseVector.FromArray(new double[3] {1547829870.0, 525077980.0, 200270.0}), new PositiveDefiniteMatrix(new double[3, 3] {{4254590363351.0, 1127383488860.0, 433199230.0}, {1127383488860.0, 482723521821.0, 146764360.0}, {433199230.0, 146764360.0, 56221.0}}));
		...
		/// <summary>
		/// Returns the marginal distribution for 'vVector__27' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public PointMass<Vector[]> VVector__27Marginal()
		{
			return this.vVector__27_marginal;
		}

		/// <summary>
		/// Returns the marginal distribution for 'vVector81' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public VectorGaussian VVector81Marginal()
		{
			return this.vVector81_marginal_F;
		}

		/// <summary>
		/// Returns the marginal distribution for 'vdouble__81' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public DistributionStructArray<Gaussian,double> Vdouble__81Marginal()
		{
			return this.vdouble__81_marginal_F;
		}

		/// <summary>
		/// Returns the marginal distribution for 'vdouble__82' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public DistributionStructArray<Gaussian,double> Vdouble__82Marginal()
		{
			return this.vdouble__82_marginal_F;
		}
