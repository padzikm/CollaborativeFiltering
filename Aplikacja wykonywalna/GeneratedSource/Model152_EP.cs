...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	public partial class Model152_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>Field backing the vVector__153 property</summary>
		private Vector[] VVector__153;
		/// <summary>The number of iterations last computed by Changed_vVector__153. Set this to zero to force re-execution of Changed_vVector__153</summary>
		public int Changed_vVector__153_iterationsDone;
		public PointMass<Vector[]> vVector__153_marginal;
		/// <summary>Message to marginal of 'vVector459'</summary>
		public VectorGaussian vVector459_marginal_F;
		/// <summary>Message to marginal of 'vdouble__460'</summary>
		public DistributionStructArray<Gaussian,double> vdouble__460_marginal_F;
		...
		/// <summary>The externally-specified value of 'vVector__153'</summary>
		public Vector[] vVector__153
		{
			get {
				return this.VVector__153;
			}
			set {
				if ((value!=null)&&(value.Length!=1)) {
					throw new ArgumentException(((("Provided array of length "+value.Length)+" when length ")+1)+" was expected for variable \'vVector__153\'");
				}
				this.VVector__153 = value;
				this.numberOfIterationsDone = 0;
				this.Changed_vVector__153_iterationsDone = 0;
			}
		}
		...
		{
			if (variableName=="vVector__153") {
				this.vVector__153 = (Vector[])value;
				return ;
			}
			throw new ArgumentException("Not an observed variable name: "+variableName);
		}
		...
		{
			if (variableName=="vVector__153") {
				return this.VVector__153Marginal();
			}
			if (variableName=="vVector459") {
				return this.VVector459Marginal();
			}
			if (variableName=="vdouble__459") {
				return this.Vdouble__459Marginal();
			}
			if (variableName=="vdouble__460") {
				return this.Vdouble__460Marginal();
			}
		...
		private void Changed_vVector__153()
		{
			...
			VectorGaussian vVectorGaussian153 = VectorGaussian.FromNatural(DenseVector.FromArray(new double[3] {1547829870.0, 525077980.0, 200270.0}), new PositiveDefiniteMatrix(new double[3, 3] {{4254590363351.0, 1127383488860.0, 433199230.0}, {1127383488860.0, 482723521821.0, 146764360.0}, {433199230.0, 146764360.0, 56221.0}}));
		...
		/// <summary>
		/// Returns the marginal distribution for 'vVector__153' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public PointMass<Vector[]> VVector__153Marginal()
		{
			return this.vVector__153_marginal;
		}

		/// <summary>
		/// Returns the marginal distribution for 'vVector459' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public VectorGaussian VVector459Marginal()
		{
			return this.vVector459_marginal_F;
		}
		...
		/// <summary>
		/// Returns the marginal distribution for 'vdouble__460' given by the current state of the
		/// message passing algorithm.
		/// </summary>
		/// <returns>The marginal distribution</returns>
		public DistributionStructArray<Gaussian,double> Vdouble__460Marginal()
		{
			return this.vdouble__460_marginal_F;
		}
